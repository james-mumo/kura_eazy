...
import useGetVoters from "../logic/useGetVoters"
import VotersTable from "../components/VotersTable"

const Voters = () => {
  const getElectionVoters = useGetVoters()
  const { handleVoterFileChanged, voters } = useContext(appContext)
  const [getVoters, setGetVoters] = useState([])
  ...
  useEffect(() => {
    setGetVoters(getElectionVoters)
    console.log(getElectionVoters)
  }, [voters, getElectionVoters, getVoters])
      ...
      <Dialog open={openModal} onClose={handleModalClose}>
        ...
        <DialogContent>
          <TextField
            ...
            onChange={(event) =>
              setAddVoter({ ...addVoter, fullName: event.target.value })
            }
            fullWidth
          />
          <TextField
            margin="dense"
            label="Voter ID"
            value={addVoter.voterID}
            onChange={(event) =>
              setAddVoter({ ...addVoter, voterID: event.target.value })
            }
            fullWidth
          />
          <TextField
          ...
          <TextField
            ...
            value={addVoter.sex}
            onChange={(event) =>
              setAddVoter({ ...addVoter, sex: event.target.value })
            }
            fullWidth
          />
          <TextField
            ...
            value={addVoter.age}
            onChange={(event) =>
              setAddVoter({ ...addVoter, age: event.target.value })
            }
            fullWidth
          />
          <TextField
